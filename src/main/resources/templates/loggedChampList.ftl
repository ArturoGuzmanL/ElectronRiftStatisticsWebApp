    ...
    <div id="ChampionsPage" class="ChampionsPage">
        ...
        <div id="championListContainer" class="championListContainer">
            <ul id="championList" class="championList">
                <#list championIndex as ChampionName, ChampionImgID>
                    <li>
                        <a href="#" class="ChampionObject">
                            <img class="ChampionImage" src="https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-icons/${ChampionImgID}.png" alt="${ChampionName}">
