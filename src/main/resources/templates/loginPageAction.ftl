            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        ...
                        <span id="PatchSpan" class="sidebar-nav-item">Patch notes</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="main-content">
        <div class="main-browser noselection">
            ...
            <div id="mainSearchField">
                <textarea class="mainSearchField" placeholder="Search summoners, champions..." readonly></textarea>
            </div>
        </div>
    </div>
</div>
...
<div class="popupBrowserWindow" id="popupBrowserWindow">
    <div class="popupBuscadorBrowser">
        <label class="popupSearchLabel">
            ...
            <input type="text" id="BrowserInput" class="popupSearchField" onkeyup="searchUpdate()" placeholder="Search summoners, champions...">
        ...
        <div class="closeBrowserBtn">
            <svg width="70" height="70" viewBox="-2.4 -2.4 28.80 28.80" fill="white" xmlns="http://www.w3.org/2000/svg" stroke="white" stroke-width="0.00024000000000000003" transform="rotate(0)">
                ...
                <g id="SVGRepo_iconCarrier">
                    <path id="rectangulo" opacity="0.4" d="M16.19 2H7.81C4.17 2 2 4.17 2 7.81V16.18C2 19.83 4.17 22 7.81 22H16.18C19.82 22 21.99 19.83 21.99 16.19V7.81C22 4.17 19.83 2 16.19 2Z" fill="#34373f"></path>
